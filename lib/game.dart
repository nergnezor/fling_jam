...
class MyGame extends BaseGame with DoubleTapDetector, TapDetector, VerticalDragDetector {
  bool running = true;
  Disc currentDisc;
  FPSCounter fpsCounter;
  MyGame() {
    Disc.startPos = window.physicalSize.bottomCenter(Offset.zero);
  ...
  void onVerticalDragUpdate(DragUpdateDetails details) {
    ...
    currentDisc.position = Vector2(details.localPosition.dx, details.localPosition.dy);
